...
def base_config(cfg_dict):
    ...
    # Dataset setting
    parser.add_argument('--trset', default='MSB-TR', help='Set the traing set')
    parser.add_argument('--vals', default='ECSSD', help='Set the testing sets') # SOD,PASCAL-S,ECSSD,DUTS-TE,HKU-IS,DUT-OMRON
    ###
    ...
    parser.add_argument('--found_crf', action='store_true')
    parser.add_argument('--spectral', action='store_true')
    parser.add_argument('--only_crf', action='store_true')
